...
<html lang="en-US">
    <head>
        ...
        <link rel="stylesheet" href="../../CSS/templateForEverySam.css">
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse">
                        <ul class="nav navbar-nav mx-auto">
                            ...
                            <li class="nav-item" role="presentation"><a class="nav-link disabled" href="">Tablet</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link disabled" href="">Computer</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link disabled" href="">TV</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link disabled" href="">Streamer</a></li>
                            <li class="nav-item" role="presentation"><a class="nav-link disabled" href="">Music</a></li>
                        </ul>
